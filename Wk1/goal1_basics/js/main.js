...
*/
	...
	if("1" === 1) {
		console.log("'1' !== 1, True"); // result is false
	}
 ...
 */
	...
	if ((1 === 1) && ("hi" === "hi")) {
		console.log("&& AND logical operator: both sides = true")
	}

	//OR logical operator
	if ((1 === 1) || ("hi" === "no")) {
		console.log("|| OR logical operator: one side = true")
	}
...
/*******************************************
 ...
 GOAL
	1. learn if - else
 ********************************************/
 // create variable named weather with the value "Cloudy"
 var weather = "cloudy";
 var bobsMood;
 ...
 if (weather == "sunny") {
 	bobsMood = "happy";
 	// console.log("Bob's bobsMood is " + bobsMood + "! The weather is beautiful and sunny.");
 } else {
 	bobsMood = "sad";
 	// console.log("Bob's bobsMood is " + bobsMood + ". The weather is Cloudy and dreary.");
 }
...
var waves = 10;
 ...
 console.log("Bob's bobsMood: " + bobsMood);
